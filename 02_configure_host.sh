...
sudo ip addr add 192.168.123.200/24 dev baremetal
sudo ip link set dev eth2 mtu 1450
sudo sh -c 'echo 172.22.0.1 provisionhost-0.rdocloud >> /etc/hosts'
sudo sed -i '/nameserver/d' /etc/resolv.conf
sudo sh -c 'echo nameserver 192.168.123.1 >> /etc/resolv.conf'
